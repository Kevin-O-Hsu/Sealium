...
class TestActivationCode:
    ...
    def test_to_from_dict_roundtrip(self):
        ...
        assert restored.bound_machine_code == "mc"
...
class TestActivationRequest:
    def test_to_dict(self):
        req = ActivationRequest(
            activation_code="c", machine_code="m", timestamp=123, nonce="n"
        )
        assert req.to_dict() == {
            "activation_code": "c",
            "machine_code": "m",
    ...
    def test_from_dict_roundtrip(self):
        req = ActivationRequest.from_dict(
            {"activation_code": "c", "machine_code": "m", "timestamp": 7, "nonce": "n"}
        )
